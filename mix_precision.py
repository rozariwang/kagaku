...
def create_data_loader(dataset):
    return DataLoader(dataset, batch_size=16, shuffle=True, num_workers=4, pin_memory=True)
...
training_args = TrainingArguments(
    ...
    num_train_epochs=5,                  # Number of training epochs from the hyperparameter optimization
